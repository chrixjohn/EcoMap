    ...
    try {
      ...
      const geoJSON = {
        ...
        features: occurrences.map((occurrence) => {
          const { spotId, speciesId, userId, expertId, _id, createdAt, updatedAt } = occurrence;
          ...
          return {
            ...
            properties: {
                ...
                conservationStatus: speciesId ? speciesId.conservation_status : null, // Conservation status from species
